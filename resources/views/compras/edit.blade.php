...
<div class="container">
    ...
    <form method="POST" action="{{ route('compras.update', $compra) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="proveedor" id="proveedor" class="form-control" required value="{{ old('proveedor', $compra->proveedor) }}">
        </div>

        <div class="mb-3">
            <label for="descripcion">Descripción *</label>
            <input type="text" name="descripcion" id="descripcion" class="form-control" required value="{{ old('descripcion', $compra->descripcion) }}">
        </div>

        <div class="mb-3">
            <label for="monto">Monto</label>
            <input type="number" step="0.01" name="monto" id="monto" class="form-control" value="{{ old('monto', $compra->monto) }}">
        </div>

        <div class="mb-3">
            <label for="fecha_compra">Fecha de Compra *</label>
            <input type="date" name="fecha_compra" id="fecha_compra" class="form-control" required value="{{ old('fecha_compra', $compra->fecha_compra) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="comentarios" id="comentarios" class="form-control">{{ old('comentarios', $compra->comentarios) }}</textarea>
        </div>
