    ...
    <form method="POST" action="{{ route('proveedores.store') }}">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input name="nombre" type="text" class="form-control @error('nombre') is-invalid @enderror" value="{{ old('nombre') }}" required>
                @error('nombre') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="col-md-6 mb-3">
                <label>Ejecutivo de venta</label>
                <input name="ejecutivo_venta" type="text" class="form-control" value="{{ old('ejecutivo_venta') }}">
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input name="linea_credito" type="number" step="0.01" class="form-control" value="{{ old('linea_credito') }}">
            </div>
            <div class="col-md-4 mb-3">
                <label>Tiempo de crédito (días)</label>
                <input name="tiempo_credito" type="number" class="form-control" value="{{ old('tiempo_credito') }}">
            </div>
            <div class="col-md-4 mb-3">
                <label>Métodos de entrega</label>
                <input name="metodos_entrega" type="text" class="form-control" value="{{ old('metodos_entrega') }}">
            </div>
            <div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select name="tipo" class="form-select">
                    ...
                    <option value="mayorista" @selected(old('tipo')=='mayorista')>Mayorista</option>
                    <option value="menudeo" @selected(old('tipo')=='menudeo')>Menudeo</option>
                    <option value="mayore-menudeo" @selected(old('tipo')=='mayore-menudeo')>Mayore-menudeo</option>
                </select>
            </div>
            <div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3 mt-4 d-flex align-items-center">
                <div class="form-check">
                    <input type="checkbox" name="factura" value="1" class="form-check-input" id="facturaCheck" {{ old('factura') ? 'checked' : '' }}>
